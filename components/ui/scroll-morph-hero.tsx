...
// --- FlipCard Component ---
const IMG_WIDTH = 100;  // Bigger as requested
const IMG_HEIGHT = 140; // Bigger as requested
...
export default function IntroAnimation() {
    ...
    useEffect(() => {
        ...
        // Attach listeners to window to ensure we catch all scrolls even with overlays
    ...
    return (
        <div ref={containerRef} className="relative w-full h-full bg-[#FAFAFA] overflow-hidden">
            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                {/* Intro Text - Shows during scatter/line phase */}
                <motion.div
                    className="absolute z-30 flex flex-col items-center justify-center text-center pointer-events-none"
                    style={{ top: '20%' }}
                    initial={{ opacity: 0, y: 30 }}
                    animate={{
                        opacity: introPhase === 'scatter' || introPhase === 'line' ? 1 : 0,
                        y: introPhase === 'scatter' || introPhase === 'line' ? 0 : -30,
                    }}
                ...
                >
                    ...
                    >
                        Pure<span style={{ fontStyle: 'italic', fontWeight: 500 }}>Share</span>
                    </h1>
                    <p
                ...
                {/* Arc Active Content (Fades in) - Hidden since we use custom overlay in page.tsx */}
                <motion.div
                    style={{ opacity: 0, y: contentY }}
                    className="absolute top-[10%] z-10 flex flex-col items-center justify-center text-center pointer-events-none px-4"
                >
                    {/* Content handled by parent component */}
                </motion.div>
                ...
                <div className="relative flex items-center justify-center w-full h-full">
                    {IMAGES.slice(0, TOTAL_IMAGES).map((src, i) => {
                        ...
                        if (introPhase === "scatter") {
                            ...
                            const baseCircleRadius = Math.min(containerSize.width * 0.50, containerSize.height * 0.50);
                            const circleRadius = Math.max(baseCircleRadius, isMobile ? 220 : 420); // Very large minimum
